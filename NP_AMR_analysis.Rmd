...
Mcat_microreact_df <- 
  sample_df %>% 
    ...
    add_to_microreact(widen_amr_data(amr_df),
                      absent_value = "Absent")
...
Mcat_microreact_df %<>%
  add_to_microreact(Mcat_Hflu_mobsuite_summary_df, absent_value = "Absent")
...
Hinflu_microreact_2_longer <- Hflu_microreact_df %>% 
...
Hinflu_microreact_2_longer_2 <- Hflu_microreact_df %>% 
  pivot_longer(cols = c(`hmrM*`, `blaROB-1`, `sul2`, `aph(3'')-Ib`, `aph(6)-Id`, `blaTEM-1`, `tet(B)`, `dfrA4`, `catA2`, `aph(3')-Ia`, `tet(C)`, `aph(3'')-Ib^`, `sul2*`, `dfrA4*`, `catA2*`, `hmrM^`, `blaROB-1*`, `aph(6)-Id*`, `aph(3')-Ia*`, `aph(3'')-Ib*`, `hmrM`, `blaROB-1^`, `catP`, `blaTEM-2`, `tet(B)^`, `blaTEM-1*`, `tet(B)*`, `tet(C)*`, `blaTEM-33`, `mef(A)`, `msr(D)`, `blaTEM-1^`), 
...
Hflu_frequency_cluster <- Hflu_microreact_df %>% 
  filter(Country == "United Kingdom") %>% 
...
### Analysis of species present in deep sequencing samples across countries

### Identification of samples containing *H. influenzae* and *M. catarrhalis*
