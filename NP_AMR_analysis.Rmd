...
species_colors=c("#D9F0A3","#A6CEE3", "#1F78B4", '#B2DF8A',"#FB9A99", 
  "#33A02C", "#E31A1C","#CAB2D6","#FF7F00","#6A3D9A",
  "#d5d5d5","#B15928","#08306B","#7CAE00" ,"#F8766D",
  "#00BFC4", "#C77CFF","#E28900","#C29A00","#F27D54",
  "#B5A000"  ,"#00BECC","#95A900", "#00B817","#B783FF",
  "#00BB44" ,"#7D96FF" ,"#00C089" ,"#F365E6", "#00C19C",
  "#00C1AD" ,"#FD7083","#00C0BD","#FFC107","#4F9FFF",
  '#EE6677', "#FEB24C", "#000000", "#004529", "#78C679","#1E88E5"
  )
names(species_colors) <- c(colnames(Mixed_bacteria_samples[-c(41,42)]),"Other")


table_Dominant_taxa<-table_Dominant_taxa%>%
  mutate(Dominant_Species = factor(Dominant_Species,levels= c('Bacillus safensis',         
                                                              'Bacillus velezensis','Enterobacter cloacae',       
                                                              'Enterobacter hormaechei','Escherichia coli'   ,         
                                                              'Acinetobacter baumannii', 'Klebsiella pneumoniae',       
                                                              'Mammaliicoccus sciuri' ,'Moraxella bovis' ,            
                                                              'Bacillus altitudinis','Moraxella lincolnii'  ,       
                                                              'Moraxella nonliquefaciens','Neisseria subflava',          
                                                              'Staphylococcus arlettae','Bacillus anthracis','Staphylococcus capitis',      
                                                              'Bacillus cereus','Staphylococcus haemolyticus',
                                                              'Staphylococcus hominis','Staphylococcus saprophyticus',
                                                              'Streptococcus dysgalactiae','Streptococcus mitis',        
                                                              'Acinetobacter variabilis','Streptococcus pyogenes',        
                                                              'Staphylococcus epidermidis','Staphylococcus aureus','Moraxella catarrhalis',
                                                              'Streptococcus pneumoniae','Haemophilus influenzae','Other')))
