...
=======
ggplot(data = assembly_stats_df) + geom_point(aes(x = `Total length`, y = N50, colour = Species)) + geom_hline(yintercept = 100000) + geom_vline(xintercept = c(1.75e+06, 2.25e+06))
>>>>>>> 2007f1bcef216c88ea517b381798cb3fe3b90443
```
...
=======
  filter(N50 > 100000 & (`Total length` > 1.75e+06 & `Total length` < 2.25e+06))
ggplot(data = summaried_df) + geom_point(aes(x = `Total length`, y = N50, colour = Species)) + geom_hline(yintercept = 100000) + geom_vline(xintercept = c(1.75e+06, 2.25e+06))
>>>>>>> 2007f1bcef216c88ea517b381798cb3fe3b90443
```
