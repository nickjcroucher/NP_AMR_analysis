...
ggplot(Mcat_genes_amr_long, aes(x = Resistant_Gene, y = Cohort, fill = Percent_present)) +
  geom_tile(color = "blue") +
  scale_fill_gradient(low = "lightyellow", high = "red") +
  labs(
...
Hinflu_genes_amr <- Hflu_microreact_df %>% 
  pivot_longer(cols = dplyr::any_of(amr_col_names),
    names_to = "Hinflu_resistant_gene",
    values_to = "status_resistant_genes") %>% 
  group_by(Cohort, Hinflu_resistant_gene) %>%
  summarise(Total = n(),
...
ggplot(Hinflu_genes_amr, aes(x = Hinflu_resistant_gene, y = Cohort, fill = percent_present)) +
  geom_tile(color = "blue") +
  scale_fill_gradient(low = "lightyellow", high = "red") +
  labs(
